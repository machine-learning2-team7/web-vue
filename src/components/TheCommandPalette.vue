...
import { useCommandStore } from "../stores/commandPalette";
...
commandStore.registerCommands([
    ...
    },
    {
        ...
        command: () => setActiveLanguage("python"),
    },
    {
        title: "Switch to SQL",
        command: () => setActiveLanguage("sql"),
    },
    {
        title: "Switch to R",
        command: () => setActiveLanguage("r"),
    },
    {
        title: "Switch to Go",
        command: () => setActiveLanguage("go"),
    },
])
